    ...
    <div class="signUp">
      ...
      >
        ...
        <el-form-item prop="avatar" label="头像" >
          <el-upload style="border: 1px solid #E8F0FE; border-radius: 10px;width: 200px;height: 200px"
      ...
      <div class="login-btn">
        <el-button @click="goBack(-1)" type="primary" plain>取消</el-button>
        <el-button type="primary" @click="addSave" plain>注册</el-button>
      </div>
    </div>
  </div>
</template>
