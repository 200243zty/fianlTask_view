...
<!--          <span class="item-index">{{ index + 1 }}</span>-->
          <span class="item-title" style="display: flex">{{ item.name }}
<!--              <span class="element"><img src="../assets/images/play.png"></span>-->
              <span class="element"><img src="../assets/images/add.png"></span>
<!--              <span class="element"><img src="../assets/images/collect.png"></span>-->
          </span>
...
export default {
  ...
  mixins: [mixins],
  computed: {
    ...mapGetters(["listOfSongs", "id",   "duration",]),
  },
};
</script>
